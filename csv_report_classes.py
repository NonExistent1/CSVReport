...
minimum and maximum and adding a class and run method.
To solve the problem I will break each line down into 4 values and take the last two to find the
average, minimum, and maximum for each year and add a class and run method.
...
had to test was that the numbers were right. Also that it still functioned after adding a class and run method.
